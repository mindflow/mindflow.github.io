...
(function() {
    ...
    this.createWorker = function(session) {
        var worker = new WorkerClient(["ace"], "ace/mode/javascript_worker", "JavaScriptWorker","./lib/worker-javascript.js");
...
(function() {
    ...
    this.createWorker = function(session) {
        var worker = new WorkerClient(["ace"], "ace/mode/css_worker", "Worker","./lib/worker-css.js");
        worker.attachToDocument(session.getDocument());
...
(function() {
    ...
    this.createWorker = function(session) {
        if (this.constructor != Mode)
            return;
        var worker = new WorkerClient(["ace"], "ace/mode/html_worker", "Worker","./lib/worker-html.js");
        worker.attachToDocument(session.getDocument());
