...
var ElementWrapper = exports.ElementWrapper = function () {
    ...
    _createClass(ElementWrapper, null, [{
        key: "wrap",
        value: function wrap(input) {
            if (input instanceof HTMLElement) {
                ...
                if (input instanceof HTMLInputElement) {
                    var type = input.type;
                    if (type === "radio") {
                        return new RadioInputElement(input);
                    }
                    if (type === "checkbox") {
                        return new CheckboxInputElement(input);
                    }
                    if (type === "password") {
                        return new PasswordInputElement(input);
                    }
                    if (type === "submit") {
                        return new SimpleElement(input);
                    } // TODO
                    return new TextInputElement(input, parent);
                }
                if (input instanceof HTMLTextAreaElement) {
                    return new TextareaInputElement(input);
                }
                return new SimpleElement(input);
            }
            if (input instanceof TextNode) {
                return new TextnodeElement(input);
            }
            return new SimpleElement(input);
        }
    }]);
    ...
    _createClass(EventWrapper, [{
        ...
        value: function getTarget() {
            if (this._element == null) {
                this._element = new ElementEvent(ElementWrapper.wrap(this._browserEvent.target), this._browserEvent.offsetX, this._browserEvent.offsetY);
            }
            return this._element;
        }
    }]);
