...
var BaseElement = exports.BaseElement = function () {
	...
	_createClass(BaseElement, [{
		...
		key: "wireEvent",
		value: function wireEvent(eventType, suffixedValue, eventName) {
			this._element[eventType] = function (event) {
				events.trigger(suffixedValue, eventName, event);
			};
		}
	}, {
...
var ElementMapper = exports.ElementMapper = function () {
    ...
    _createClass(ElementMapper, null, [{
        ...
        value: function mapsToRadio(input) {
            return input instanceof HTMLInputElement && input.type == "radio" || input instanceof _xmlparser.XmlElement && input.getName() === "input" && input.getAttribute("type").getValue() === "radio";
        }
    }, {
        key: "mapsToCheckbox",
        value: function mapsToCheckbox(input) {
            return input instanceof HTMLInputElement && input.type == "checkbox" || input instanceof _xmlparser.XmlElement && input.getName() === "input" && input.getAttribute("type").getValue() === "checkbox";
        }
    }, {
        key: "mapsToPassword",
        value: function mapsToPassword(input) {
            return input instanceof HTMLInputElement && input.type == "password" || input instanceof _xmlparser.XmlElement && input.getName() === "input" && input.getAttribute("type").getValue() === "password";
        }
    }, {
        key: "mapsToSubmit",
        value: function mapsToSubmit(input) {
            return input instanceof HTMLInputElement && input.type == "submit" || input instanceof _xmlparser.XmlElement && input.getName() === "input" && input.getAttribute("type").getValue() === "submit";
        }
    }, {
        key: "mapsToText",
        value: function mapsToText(input) {
            return input instanceof HTMLInputElement && input.type == "text" || input instanceof _xmlparser.XmlElement && input.getName() === "input" && input.getAttribute("type").getValue() === "text";
        }
    }, {
        key: "mapsToTextnode",
        value: function mapsToTextnode(input) {
            return input instanceof Node && input.nodeType === "TEXT_NODE" || input instanceof _xmlparser.XmlCdata;
        }
    }, {
        key: "mapsToTextarea",
        value: function mapsToTextarea(input) {
            return input instanceof HTMLTextAreaElement || input instanceof _xmlparser.XmlElement && input.getName() === "textarea";
        }
    }, {
        key: "mapsToSimple",
        value: function mapsToSimple(input) {
            return input instanceof HTMLElement || input instanceof _xmlparser.XmlElement;
        }
    }]);
  ...
  _createClass(Component, [{
    ...
    value: function registerElementEvents(xmlElement, element) {
      this._events.forEach(function (eventType, parent) {
        if (!(xmlElement instanceof _xmlparser.XmlElement)) {
          return true;
        }
        if (xmlElement.containsAttribute(eventType)) {
          var eventName = xmlElement.getAttribute(eventType).getValue();
          var suffixedValue = eventName + "_" + parent._idSuffix;
          element.wireEvent(eventType, suffixedValue, eventName);
        }
        return true;
      }, this);
    }
    ...
    _createClass(EventWrapper, [{
        ...
        value: function getTarget() {
            if (this._element == null) {
                this._element = new ElementEvent(ElementMapper.map(this._browserEvent.target), this._browserEvent.offsetX, this._browserEvent.offsetY);
            }
            return this._element;
        }
    }]);
...
var StyleUtil = exports.StyleUtil = function () {
    ...
    _createClass(StyleUtil, null, [{
        ...
        value: function set(element, key, value) {
            ...
            var attributeString = "";
            styleMap.forEach(function (curKey, curValue, parent) {
                attributeString = attributeString + curKey + ":" + curValue + ";";
                return true;
            }, this);
    ...
    _createClass(InputMapping, [{
        ...
        value: function to(field) {
            ...
            var puller = function puller(event) {
                if (field instanceof AbstractInputElement) {
                    ...
                    if (field instanceof RadioInputElement) {
                        if (field.isChecked()) {
                            PropertyAccessor.setValue(fieldDestination, field.getName(), field.getValue());
                        }
                    } else if (field instanceof CheckboxInputElement) {
                        if (field.isChecked()) {
                            PropertyAccessor.setValue(fieldDestination, field.getName(), field.getValue());
                        } else {
                            PropertyAccessor.setValue(fieldDestination, field.getName(), null);
                        }
                    } else {
                        PropertyAccessor.setValue(fieldDestination, field.getName(), field.getValue());
                    }
            ...
            var pusher = function pusher() {
                var value = PropertyAccessor.getValue(fieldDestination, field.getName());
                if (field instanceof AbstractInputElement) {
