...
var EventWrapper = exports.EventWrapper = function () {
    ...
    _createClass(EventWrapper, [{
        ...
        value: function getTarget() {
            return new ElementEvent(this._event);
        }
    }]);
    ...
    _createClass(InputMapping, [{
        ...
        value: function to(field) {
            ...
            var puller = function puller(event) {
                if (field instanceof AbstractInputElement) {
                    ...
                    if (field instanceof RadioInputElement) {
                        if (field.isChecked()) {
                            _coreutil.PropertyAccessor.setValue(fieldDestination, field.getName(), field.getValue());
                        }
                    } else if (field instanceof CheckboxInputElement) {
                        if (field.isChecked()) {
                            _coreutil.PropertyAccessor.setValue(fieldDestination, field.getName(), field.getValue());
                        } else {
                            _coreutil.PropertyAccessor.setValue(fieldDestination, field.getName(), null);
                        }
                    } else {
                        _coreutil.PropertyAccessor.setValue(fieldDestination, field.getName(), field.getValue());
                    }
            ...
            var pusher = function pusher() {
                var value = _coreutil.PropertyAccessor.getValue(fieldDestination, field.getName());
                if (field instanceof AbstractInputElement) {
